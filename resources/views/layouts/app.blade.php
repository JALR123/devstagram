    ...
    <body class="bg-gray-100">
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center ">
                <a href="{{route('home')}}" class="text-3xl font-black">Devstagram</h1>


                @auth <!--Directiva que comprueba si el usuario esta autenticado-->
                ...
                @guest <!--Directiva que comprueba si no esta autenticado-->
                <nav class="flex gap-2 items-center">
